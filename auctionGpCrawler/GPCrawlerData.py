...
class CrawlerData:
    ...
    def getPage(self,url):
        ...
        headers = {'User-Agent': user_agent,'Referer':'http://www.gpai.net/sf/'}
        maxTryNum = 10
        html = ''
    ...
    def getLabel(self,url):
        ...
        return labelList
    def getDataList(self,url,court_id,kind,circle):
        jsonData = {}
        ...
        return jsonData
    def getItemHtml(self,url,court_id,kind,circle):
        ...
        for urls in urlList:
            ...
            jsonData = self.getDataList(url,court_id,kind,circle)
                ...
                for circle in self.circleList:
                    ...
                    if int(label[0])>0:
                        for i in range(1, int(self.getPageNum(urlForPageNum)) + 1):
                         ...
                         #print url
                         itemUrlList = self.getItemHtml(url,court[1],kind[1],circle)
                print court[2] + "抓取完成"
